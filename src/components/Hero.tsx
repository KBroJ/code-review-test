      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="relative z-10">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="inline-flex items-center justify-center w-32 h-32 bg-gradient-to-br from-primary-500 to-accent-500 rounded-full shadow-2xl shadow-primary-500/30">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 animate-slide-up">
            ...
            <br />
            <span className="text-gradient">딩코딩코</span>
